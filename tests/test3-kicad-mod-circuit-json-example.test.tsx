...
test("test3 kicad mod circuit json example", async () => {
  ...
  expect(tscircuit).toMatchInlineSnapshot(`
    ...
    <smtpad portHints={["14"]} pcbX="8.278mm" pcbY="7.62mm" layer="top" width="1.626mm" height="1.325mm" shape="rect" />
    <silkscreenpath route={[{"x":-8.89,"y":-8.509},{"x":-8.89,"y":8.636}]} layer="top" strokeWidth={0.1} />
    <silkscreenpath route={[{"x":-6.985,"y":-10.414},{"x":6.985,"y":-10.414}]} layer="top" strokeWidth={0.1} />
    <silkscreenpath route={[{"x":6.985,"y":10.541},{"x":-6.985,"y":10.541}]} layer="top" strokeWidth={0.1} />
    <silkscreenpath route={[{"x":8.89,"y":-8.509},{"x":8.89,"y":8.636}]} layer="top" strokeWidth={0.1} />
    <silkscreenpath route={[{"x":-8.89,"y":8.636},{"x":-8.634777964987212,"y":9.588499698293818},{"x":-7.937499698293819,"y":10.285777964987211},{"x":-6.985,"y":10.541}]} layer="top" strokeWidth={0.1} />
    <silkscreenpath route={[{"x":-6.985,"y":-10.414},{"x":-7.937499698293818,"y":-10.158777964987209},{"x":-8.63477796498721,"y":-9.461499698293817},{"x":-8.89,"y":-8.509}]} layer="top" strokeWidth={0.1} />
    <silkscreenpath route={[{"x":6.985,"y":10.541},{"x":7.937499698293818,"y":10.285777964987211},{"x":8.63477796498721,"y":9.588499698293818},{"x":8.889999999999999,"y":8.636}]} layer="top" strokeWidth={0.1} />
    <silkscreenpath route={[{"x":8.89,"y":-8.509},{"x":8.63477796498721,"y":-9.461499698293817},{"x":7.937499698293818,"y":-10.158777964987209},{"x":6.985,"y":-10.413999999999998}]} layer="top" strokeWidth={0.1} />
